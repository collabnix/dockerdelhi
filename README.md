# Docker Delhi Meetup Community Page

Welcome to the Docker Delhi Meetup Community repo! This repo aims to centralize content (Meetup presentations, slides, recorded videos, etc) curated by the community members for the Docker Meetup Community. The main objective is to help members of the Docker  Meetup community who share similar interests to learn from & collaborate with each other during events. 
...
[Docker Delhi Meetup #19: Docker & K8s WorkShop - Xebia](https://github.com/collabnix/dockerhyderabad/blob/master/slides/README.md)
...
Visit [Docker Delhi official Community Page](https://events.docker.com/delhi/) for registering to the Community Page.
